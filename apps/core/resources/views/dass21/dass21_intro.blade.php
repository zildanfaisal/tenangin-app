...
<div class="min-h-screen flex flex-col bg-[#f5f7fb]">
  ...
  <div class="flex items-center gap-2 px-6 pt-6">
    <a href="{{ route('dass21.index') }}" class="flex items-center text-gray-600 hover:text-indigo-600 transition">
  ...
  {{-- Konten utama --}}
  <div class="flex flex-col md:flex-row flex-1 rounded-2xl overflow-hidden shadow-md mx-6 my-6 bg-white">
    {{-- Kiri: Konten teks --}}
    <div class="flex-1 p-8 md:p-12 flex flex-col justify-center">
      ...
      {{-- Info card --}}
        ...
        <div class="border border-gray-200 rounded-xl p-4 flex flex-col items-center justify-center h-32">
            <p class="text-3xl font-bold text-indigo-600">21</p>
            <p class="text-sm text-gray-600 mt-1">Pertanyaan</p>
        </div>
    ...
    <div class="md:w-5/12 h-64 md:h-auto md:min-h-full bg-cover bg-center"
