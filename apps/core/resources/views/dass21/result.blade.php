...
@section('content')
<div class="min-h-screen bg-[#f5f7fb] pb-20 md:pb-24">

  {{-- 🔹 Header --}}
  <div class="w-full flex items-center justify-between px-4 md:px-6 py-4 md:py-5 bg-[#f5f7fb]">
    ...
    <h1 class="text-lg md:text-2xl font-bold text-blue-700 text-center flex-1 -translate-x-3 md:-translate-x-8">
  ...
  <div class="max-w-6xl mx-auto rounded-2xl md:rounded-3xl overflow-hidden shadow-lg bg-cover bg-center relative"
    ...
    <div class="relative z-10 px-5 py-10 md:px-14 md:py-16 flex flex-col md:flex-row justify-between items-start md:items-center text-white">
      <div class="flex-1">
        <div class="flex flex-wrap items-center gap-2 text-xs md:text-sm opacity-90 mb-3">
  ...
  <div class="max-w-6xl mx-auto px-4">
    ...
    @php $cards = $penanganan ?? collect(); @endphp
      ...
      <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
        @foreach($cards as $item)
          <div class="bg-white rounded-2xl shadow-md hover:shadow-xl transition-all p-5 md:p-6 flex flex-col">
            ...
            <p class="text-sm text-gray-700 flex-1 line-clamp-3">{{ str($item->deskripsi_penanganan)->limit(160) }}</p>
